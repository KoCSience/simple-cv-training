...
@pytest.mark.parametrize("batch_size,num_workers,frames_per_clip,clips_per_video", [[1, 1, 1, 1], [4, 4, 8, 2]])
...
def test_video_folder(
    ...
    train_transform, val_transform = transform_video(TransformVideoInfo(frames_per_clip=frames_per_clip))
    train_loader, val_loader, n_classes = video_folder(
        VideoFolderInfo(
            root=root,
            train_dir=train_dir,
            val_dir=val_dir,
